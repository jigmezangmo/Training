...
```    
    ...
    a more advanced version using everyting we learned!

    This time, John and his family went to 5 different
    restaurants. The bills were $124, $48, $268, $180 and
    $42.
    ...
    5. Implements the same functionality as before, this
    time using Mark's tipping rules
    6. Create a function (not a method) to calculate the
    average fo a given array of tips. HINT: Loop over the
    array, and in each iteration store the current
    sum in a variable (starting form 0). After you have the
    sum of the array, divide it by the number of elements in 
    it (that's how you calculate the average)
...
var age = 25; // gobal execution context
...
// Example ot show the difference between execution stack and scope chain
